...
> <br>To control the visibility of class members (the security level of each individual class and class member).
> <br>To achieve **"Encapsulation"** - which is the process of making sure that "sensitive" data is hidden from users. This is done by declaring fields as `private`. You will learn more about this in the next chapter.
