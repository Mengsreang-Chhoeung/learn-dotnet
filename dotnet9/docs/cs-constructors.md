...
> <br>Also note that the constructor is called when the object is created.
> <br>All classes have constructors by default: if you do not create a class constructor yourself, C# creates one for you. However, then you are not able to set initial values for fields.
> <br>**Constructors save time!** Take a look at the last example on this page to really understand why.
